...
public class PixelDungeon extends Game {
	...
	public PixelDungeon() {
		...
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.scrolls.ScrollOfUpgrade.class, 
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfEnhancement" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.actors.blobs.WaterOfHealth.class, 
			"com.watabou.pixeldungeon.actors.blobs.Light" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.rings.RingOfMending.class, 
			"com.watabou.pixeldungeon.items.rings.RingOfRejuvenation" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.wands.WandOfReach.class, 
			"com.watabou.pixeldungeon.items.wands.WandOfTelekenesis" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.actors.blobs.Foliage.class, 
			"com.watabou.pixeldungeon.actors.blobs.Blooming" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.actors.buffs.Shadows.class, 
			"com.watabou.pixeldungeon.actors.buffs.Rejuvenation" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.scrolls.ScrollOfPsionicBlast.class, 
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfNuclearBlast" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.actors.hero.Hero.class, 
			"com.watabou.pixeldungeon.actors.Hero" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.actors.mobs.npcs.Shopkeeper.class,
			"com.watabou.pixeldungeon.actors.mobs.Shopkeeper" );
		// 1.6.1
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.quest.DriedRose.class,
			"com.watabou.pixeldungeon.items.DriedRose" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.actors.mobs.npcs.MirrorImage.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfMirrorImage$MirrorImage" );
		// 1.6.4
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfCleansing" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfResistance" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.weapon.missiles.Boomerang.class,
			"com.watabou.pixeldungeon.items.weapon.missiles.RangersBoomerang" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.rings.RingOfPower.class,
			"com.watabou.pixeldungeon.items.rings.RingOfEnergy" );
		// 1.7.2
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.plants.Dreamweed.class,
			"com.watabou.pixeldungeon.plants.Blindweed" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.plants.Dreamweed.Seed.class,
			"com.watabou.pixeldungeon.plants.Blindweed$Seed" );
		// 1.7.4
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Piercing" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Swing" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.items.scrolls.ScrollOfEnchantment.class,
		...
		// 1.8.0
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.actors.mobs.FetidRat.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Ghost$FetidRat" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.plants.Rotberry.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Wandmaker$Rotberry" );
		com.lh64.utils.Bundle.addAlias( 
			com.lh64.randomdungeon.plants.Rotberry.Seed.class,
