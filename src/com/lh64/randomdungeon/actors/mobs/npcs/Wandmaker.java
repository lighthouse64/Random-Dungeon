...
import com.lh64.randomdungeon.items.quest.CorpseDust;
import com.lh64.randomdungeon.items.quest.PhantomFish;
import com.lh64.randomdungeon.items.wands.Wand;
import com.lh64.randomdungeon.items.wands.WandOfAmok;
import com.lh64.randomdungeon.items.wands.WandOfAvalanche;
import com.lh64.randomdungeon.items.wands.WandOfBlink;
import com.lh64.randomdungeon.items.wands.WandOfDisintegration;
import com.lh64.randomdungeon.items.wands.WandOfFirebolt;
import com.lh64.randomdungeon.items.wands.WandOfLightning;
import com.lh64.randomdungeon.items.wands.WandOfPoison;
import com.lh64.randomdungeon.items.wands.WandOfReach;
...
import com.lh64.randomdungeon.sprites.WandmakerSprite;
import com.lh64.randomdungeon.utils.Utils;
import com.lh64.randomdungeon.windows.WndQuest;
import com.lh64.randomdungeon.windows.WndWandmaker;
	...
	public static class Quest {
		...
		public static void spawn( Level level, Room room ) {
			if (!spawned && Dungeon.depth > 6 && Random.Int( 10 - Dungeon.depth ) == 0) {
				...
				do {
					npc.pos = room.random();
				} while (level.map[npc.pos] == Terrain.ENTRANCE || level.map[npc.pos] == Terrain.SIGN  || level.map[npc.pos] == Chest.cpos);
				level.mobs.add( npc );
